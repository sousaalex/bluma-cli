...
export const renderBlumaNotebook = ({ args }: RenderProps): React.ReactElement => {
    ...
    try {
      ...
      const thinkingData: ThinkingData = typeof dataToParse === 'string' 
      ...
      return (
        ...
        <Box borderStyle="round" borderColor="green" flexDirection="column" paddingX={1}>
          ...
          {thinkingData.remaining_tasks && thinkingData.remaining_tasks.length > 0 && (
            <Box marginTop={1} flexDirection="column">
      ...
      return (
        <Box borderStyle="round" borderColor="blue" paddingX={1}>
          <Text color="blue" bold>Thinking (Error)</Text>
